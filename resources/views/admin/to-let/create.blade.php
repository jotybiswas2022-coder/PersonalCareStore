...
<div class="tl-form-body">
    <div class="tl-form-card tl-animate" style="animation-delay:0.1s;">
        ...
        <form method="POST" action="{{ route('admin.to-let.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-grid-3">
                <div class="span-3 form-group">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title') }}" placeholder="e.g. Modern 3-Bedroom Flat in Dhanmondi" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="available_from" name="available_from" value="{{ old('available_from') }}" required>
                </div>
                <div class="form-group">
                    <label for="bedrooms">Bedrooms <span class="required">*</span></label>
                    <input type="number" id="bedrooms" name="bedrooms" value="{{ old('bedrooms', 1) }}" min="0" required>
                </div>
                <div class="form-group">
                    <label for="bathrooms">Bathrooms <span class="required">*</span></label>
                    <input type="number" id="bathrooms" name="bathrooms" value="{{ old('bathrooms', 1) }}" min="0" required>
                </div>
                <div class="form-group">
                    <label for="monthly_rent">Monthly Rent (৳) <span class="required">*</span></label>
                    <input type="number" id="monthly_rent" name="monthly_rent" value="{{ old('monthly_rent') }}" min="0" required>
                </div>
                <div class="form-group">
                    <label for="property_size">Property Size (sqft)</label>
                    <input type="number" id="property_size" name="property_size" value="{{ old('property_size') }}" min="0" step="0.01" placeholder="Optional">
                    <div class="help-text">Total area in square feet</div>
                </div>
                <div class="span-3 form-group">
                    <label for="description">Description</label>
                    <textarea id="description" name="description" placeholder="Describe the property features, amenities, nearby landmarks, transport links, security features, floor level, etc." style="min-height:120px;">{{ old('description') }}</textarea>
                </div>
            </div>
            ...
            <div class="form-grid-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="district" name="district" value="{{ old('district') }}" placeholder="e.g. Dhaka" required>
                </div>
                <div class="form-group">
                    <label for="area_location">Area / Location <span class="required">*</span></label>
                    <input type="text" id="area_location" name="area_location" value="{{ old('area_location') }}" placeholder="e.g. Dhanmondi 27" required>
                </div>
                <div class="span-3 form-group">
                    <label for="full_address">Full Address <span class="required">*</span></label>
                    <textarea id="full_address" name="full_address" placeholder="House #, Road #, Block, Area" style="min-height:70px;" required>{{ old('full_address') }}</textarea>
                </div>
            </div>
            ...
            <div class="form-grid-3">
                <div class="form-group">
                    ...
                    <input type="text" id="contact_name" name="contact_name" value="{{ old('contact_name') }}" placeholder="Full name" required>
                </div>
                <div class="form-group">
                    <label for="contact_phone">Contact Phone <span class="required">*</span></label>
                    <input type="text" id="contact_phone" name="contact_phone" value="{{ old('contact_phone') }}" placeholder="e.g. 01XXXXXXXXX" required>
                </div>
                <div class="form-group">
            ...
            <div class="form-group" style="max-width:700px;">
                <div class="image-upload-area" id="imageUploadArea">
                    ...
                    <p><strong>Click to upload</strong> or drag and drop property photos</p>
                ...
                <div class="help-text" style="margin-top:0.5rem;">At least <strong>1 photo</strong> is required. You can upload up to 5 photos.</div>
