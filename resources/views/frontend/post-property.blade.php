...
.progress-step .step-label { font-size: 0.75rem; font-weight: 500; color: var(--text-muted); transition: all 0.3s; }
...
.error-summary svg { color: #EF4444; flex-shrink: 0; margin-top: 2px; }
