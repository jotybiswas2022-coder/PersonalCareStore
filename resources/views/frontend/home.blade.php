...
.hero-scene .person-arm { animation: armWave 4s ease-in-out 0.5s infinite; transform-origin: 132px 138px; }
...
/* ── Sad Face (initial) ── */
.hero-scene .face-sad { animation: fadeOut 3.5s ease-in-out forwards; }
@keyframes fadeOut { 0%,70% { opacity: 1; } 100% { opacity: 0; } }

/* ── Happy Face (after finding) ── */
.hero-scene .face-happy { animation: fadeIn 1s ease-in-out 3s forwards; opacity: 0; }
@keyframes fadeIn { 0% { opacity: 0; } 100% { opacity: 1; } }

/* ── Magnifying Glass ── */
.hero-scene .search-glass { animation: glassSweep 4s ease-in-out 1.5s 2; transform-origin: 160px 114px; opacity: 0; animation-fill-mode: forwards; }
...
.hero-scene .glass-hide { animation: glassFadeOut 0.8s ease-in 3.2s forwards; }
@keyframes glassFadeOut { 0% { opacity: 1; } 100% { opacity: 0; transform: scale(0.5); } }

/* ── House pops up (delayed - after searching) ── */
.hero-scene .house-found { animation: housePop 1s cubic-bezier(0.34,1.56,0.64,1) 2.8s forwards, houseWiggle 4s ease-in-out 4s infinite; opacity: 0; transform-origin: 214px 168px; }
...
/* ── Happy Jump ── */
.hero-scene .happy-jump { animation: jumpHappy 0.6s ease-in-out 3.2s infinite; }
@keyframes jumpHappy { 0%,100% { transform: translateY(0); } 25% { transform: translateY(-10px); } 50% { transform: translateY(0); } }

/* ── Sparkles ── */
.hero-scene .sparkle { animation: sparklePop 2s ease-out 3.4s infinite; opacity: 0; }
...
/* ── Checkmark ── */
.hero-scene .checkmark { animation: checkPop 1s cubic-bezier(0.34,1.56,0.64,1) 3.8s forwards; opacity: 0; transform-origin: 214px 140px; }
...
/* ── Found badge bounce ── */
.hero-scene .found-text { animation: badgeBounce 0.8s cubic-bezier(0.34,1.56,0.64,1) 4.2s forwards; opacity: 0; }
...
.hero-scene .travel-dot { animation: dotTravel 2s ease-in-out 3s infinite; }
...
.hero-scene .raindrop { animation: rainFall 1.5s linear infinite; }
@keyframes rainFall { 0% { opacity: 0; transform: translateY(-20px); } 50% { opacity: 0.5; } 100% { opacity: 0; transform: translateY(40px); } }
